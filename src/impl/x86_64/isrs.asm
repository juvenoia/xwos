...
isr14:
    cli
    ; this might cause a 3-level page fault. before we utilize the memory controller,
    ; such isr is indeed trouble-causing.
    push 14
    ; this error code is a long long!!
    jmp isr_common_stub
...
irq_common_stub:
    ...
    push rbp
    push rsi
    push rdi ; push aq is equ to this.
